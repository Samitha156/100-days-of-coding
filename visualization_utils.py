...
STANDARD_COLORS = [
    'Teal', 'Snow', 'Orchid', 'Aquamarine', 'Azure', 'Beige', 'Bisque',
    ...
    'SlateGray', 'SlateGrey', 'Violet', 'SpringGreen', 'SteelBlue', 'GreenYellow', 
	'Thistle', 'Tomato', 'Turquoise', 'Wheat', 'White',
    'WhiteSmoke', 'Yellow', 'YellowGreen', 'AliceBlue', 'Chartreuse', 'Aqua'
]
...
def visualize_boxes_and_labels_on_image_array_old(
    image,
    boxes,
    classes,
    scores,
